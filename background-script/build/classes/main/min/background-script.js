...
this['background-script'] = function (_, Kotlin) {
  ...
  initDefaultLocalization$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: []};
  ...
  updateLanguagesList$lambda$lambda$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: []};
